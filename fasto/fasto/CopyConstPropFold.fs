            ...
            match e' with
                ...
                | Constant (c, _) ->
                    ...
                    *)
                    ...
                    let body' = copyConstPropFoldExp vtable' body
                    Let (Dec (name, e', decpos), body', pos)
                | Let (Dec (innerName, innerExp, innerDecpos), innerBody, innerPos) ->
                    (* TODO project task 3:
                    ...
                    *)
                    ...
                    let vtable'' = match innerBody' with
                    ...
                    let eLet = copyConstPropFoldExp vtable e'
                    match eLet with
                    | Let (Dec (_, e'', _), b', _) -> 
        ...
        | Times (e1, e2, pos) ->
            (* TODO project task 3: implement as many safe algebraic
               ...
               yourself from the case of `Plus`. For example:
                     ...
                     x * 0 = ?
            *)
            (* To be fair, one could implement infinitely many safe algebraic simplifications, so we consider
               the given examples to be sufficient.
            *)
